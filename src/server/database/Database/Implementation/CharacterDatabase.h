...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_SEL_PROCESSED_ORDER,
    CHAR_INS_PROCESSED_ORDER,

    CHAR_UPD_CHARACTER_KAFKA_OK,
    CHAR_UPD_CHARACTER_GEAR_KAFKA_OK,
    CHAR_UPD_CHARACTER_GEAR_KAFKA_NOT_OK,
    CHAR_SEL_CHARACTER_KAFKA_PENDING,
    CHAR_SEL_CHARACTER_GEAR_KAFKA_PENDING,
    CHAR_UPD_PROCESSED_SHOP_ORDERS_KAFKA_OK,
    CHAR_SEL_PROCESSED_SHOP_ORDERS_KAFKA_PENDING,
